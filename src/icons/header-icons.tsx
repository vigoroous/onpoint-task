...
const IconHome = () =>
    <svg xmlns="http://www.w3.org/2000/svg" width="43.875" height="38.438" viewBox="0 0 43.875 38.438">
...
const IconDivider = () =>
    <svg xmlns="http://www.w3.org/2000/svg" width="4" height="52" viewBox="0 0 4 52">
        <path className="icon-divider" d="M93,50V1" transform="translate(-92)" />
    </svg>


export { IconHome, IconDivider }